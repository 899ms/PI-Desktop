...
| 0301 | [A failed compaction keeps the recent window, and an oversized summary is chunked](0301-compaction-fallback-recent-window-and-chunked-summary.md) | Accepted for implementation (issue #827; amends ADR 0049 / ADR 0282) |
