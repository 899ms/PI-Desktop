...
<!-- In flight on feat/chat-wide-layout: claims 0274, which main has since taken. The
     owner renumbers it (0276) when that branch lands; this row is not rewritten here. -->
| (pending 0276) | [Draggable chat content width](0274-draggable-chat-content-width.md) | Accepted (D439) |
