# ADR 0294: Provider-hosted web search as an adapter capability
...
- pi-ai 0.85.1 drops vendor search blocks in both adapters: the Anthropic
...
2. **Attachment and extraction live in the pi-ai adapters**, delivered by
   extending `patches/@earendil-works__pi-ai@0.85.1.patch`:
   ...
   transition; `patches/@earendil-works__pi-agent-core@0.85.1.patch` teaches
