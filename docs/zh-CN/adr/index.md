...
| 0283 | [`packages/host-runtime` 的无头运行时边界](/adr/0283-headless-runtime-boundary) | 已接受（实施中）（D447；ADR 0205 R2 前置） |
| 0284 | [`packages/racp` 的 `RACP-WS` 传输](/adr/0284-racp-ws-transport) | 已接受（实施中）（D448；ADR 0205 R2） |
