...
- **步骤**：
  ...
  6. 在选中第二个文件夹的情况下，用文件树搜索主文件夹里那个文件的名字，并试着打开 `.env`，以及第二个文件夹里指向外部的符号链接或 junction。
- **预期**：
...
- **链接规格**：`07-plugins/03-plugin-api.md` §3、`04-ux/08-component-spec.md` §5.2.2、ADR 0241、ADR 0249、ADR 0252
- **接受**：G（插件）、安全性、品质
- **里程碑**：M6+
