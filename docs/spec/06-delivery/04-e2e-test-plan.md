...
- **Steps:** Choose a model in Advanced, cancel and verify no change; save, replace
  and clear it through Settings. Generate same-prompt variants and distinct images,
