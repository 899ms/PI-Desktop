...
#### E2E-249: Quoting a message or a selection prefills the composer without sending
...
- **Steps**: 1) Hover the user message and activate Quote. 2) Inspect the
  ...
  assistant answer and activate the floating quote affordance that appears on
  the selection's last line. 4) Send the
...
- **Expected**: The draft gains `> ` on every excerpt line, one blank line, then
  ...
  session switch. Step 3 shows exactly one affordance labelled
  `chat.quoteSelection`, placed on the selection's last line inside the
  viewport, hidden again by scrolling the thread, resizing the window, or
  collapsing the selection, and absent from the read-only side-chat projection
  of the same message.
- **Specs linked**: `04-ux/08-component-spec.md` §8.8, §11.9;
  `04-ux/09-interaction-patterns.md` §7.5, §8a.2; ADR 0223, D398, D399
- **Acceptance**: C (conversation), Quality
- **Milestone**: M6+
- **Status**: Draft

#### E2E-250: Opening a side chat forks the child without switching the visible session
...
- **Specs linked**: `04-ux/08-component-spec.md` §5.8, §8.8;
  ...
  ADR 0223, ADR 0023, D398
- **Acceptance**: C (conversation), F (persistence), Quality
- **Milestone**: M6+
- **Status**: Draft

#### E2E-251: The side-chat panel streams the child's turn live
...
- **Specs linked**: `04-ux/08-component-spec.md` §5.8, §11.2;
  `03-runtime/10-session-state-machine.md`; ADR 0223, ADR 0023
- **Acceptance**: C (conversation), E (permissions), Quality
- **Milestone**: M6+
- **Status**: Draft

#### E2E-252: Add to main chat prefills the main composer with the newest answer
...
- **Specs linked**: `04-ux/08-component-spec.md` §5.8, §11.9; ADR 0223, D398
- **Acceptance**: C (conversation), Quality
- **Milestone**: M6+
- **Status**: Draft

#### E2E-253: Open as a conversation activates the child and releases the panel entry
...
- **Specs linked**: `04-ux/08-component-spec.md` §5.8;
  `04-ux/09-interaction-patterns.md` §1.8; ADR 0223, ADR 0023, D128
- **Acceptance**: C (conversation), F (persistence), Quality
- **Milestone**: M6+
- **Status**: Draft

#### E2E-254: Closing the side-chat tab keeps the child session
...
- **Specs linked**: `04-ux/08-component-spec.md` §5.8;
  `03-runtime/04-data-storage.md`; ADR 0223, ADR 0023, D128
- **Acceptance**: C (conversation), F (persistence), Quality
- **Milestone**: M6+
- **Status**: Draft

#### E2E-255: Quoting a formula, a table, and a code block recovers Markdown
...
- **Steps**: 1) Drag-select part of the inline formula and activate the floating
  ...
  step, then select a phrase and scroll the thread, resize the window, collapse
  the selection, and open the same message in a side-chat projection.
- **Expected**: Each draft carries the rendered text as Markdown: `$…$` TeX for
  ...
  affordance is the only one on screen, sits on the selection's last line and
  inside the viewport, disappears on scroll, resize, and selection collapse, and
  is absent from a read-only side-chat projection.
- **Specs linked**: `04-ux/08-component-spec.md` §8.8, §11.9;
  `04-ux/09-interaction-patterns.md` §7.5; ADR 0223, D399
- **Acceptance**: C (conversation), Quality
- **Milestone**: M6+
- **Status**: Draft
...
| M6+ | E2E-121, E2E-122, E2E-148, E2E-150, E2E-151, E2E-154, E2E-155, E2E-158, E2E-159, E2E-160, E2E-161, E2E-162, E2E-163, E2E-166, E2E-168, E2E-173, E2E-174, E2E-176, E2E-179, E2E-196a, E2E-196b, E2E-196c, E2E-198, E2E-199, E2E-200, E2E-202, E2E-203, E2E-205, E2E-209, E2E-210, E2E-212, E2E-213, E2E-214, E2E-215, E2E-216, E2E-217, E2E-218, E2E-219, E2E-249, E2E-250, E2E-251, E2E-252, E2E-253, E2E-254, E2E-255 |
