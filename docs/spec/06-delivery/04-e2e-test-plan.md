...
- **Specs linked**: `04-ux/01-ui-ia.md`, ADR 0251, D421
...
- **Specs:** runtime §12; storage §12; security §12; ADR 0251.
...
- **Specs:** IPC native routing; runtime §12; storage §12; UX side chat; ADR 0251.
- **Status:** Documented; run after integration into main.
