...
- A pending queue row is locked until Host admission returns its durable id: move
  up/down, Send now, edit, and remove are disabled. Edit/remove tooltips explain
  that it is saving. Direct edit/remove actions leave the pending row and draft
