...
sklm: {
    ...
    remoteHosts: {
      ...
      sshBody:
        "PI-Desktop installs pi-host on a machine you already reach with ssh, verifies the checksum the release publishes, starts it on loopback, and pairs with it. Your own SSH keys authenticate — no password is stored.",
      sshHost: "SSH host",
