...
export const es = {
  ...
  "search": {
    ...
    messageContext: "Contexto del mensaje",
    returnToConversation: "Volver a la conversación",
    contextUnavailable: "Mensaje no disponible. Puede haberse eliminado.",
    retry: "Reintentar",
    previousMatch: "Coincidencia anterior",
    nextMatch: "Siguiente coincidencia",
    previousMessages: "Mensajes anteriores",
    nextMessages: "Mensajes siguientes",
