...
sklm: {
      ...
      sourcesHint:
        "Consulta varias fuentes a la vez. Una fuente es un archivo JSON estático con el esquema del mercado de skills; también puede apuntar a tu propio repo de skills en GitHub.",
