...
sklm: {
    ...
    proxyFakeIp: "Permitir fake-IP del proxy para fuentes de red",
    proxyFakeIpDesc: "Actívalo solo con un proxy transparente de router/TUN. Las descargas del mercado y de imágenes pueden usar el proxy; las demás direcciones privadas siguen bloqueadas.",
