...
sklm: {
    ...
    "modelsSummaryLoading": "Cargando modelos…",
    "modelsSummaryFailed": "No se pudieron cargar los modelos. Revise la conexión de arriba o añada un modelo por su ID.",
    "manageModels": "Gestionar modelos",
    "collapseModels": "Contraer",
    "addModelManually": "Añadir un modelo manualmente",
