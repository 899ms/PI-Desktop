...
export const es = {
  ...
  "project": {
    ...
    "createNamePlaceholder": "Nombre del proyecto",
    "createFoldersLabel": "Carpetas",
    "createComputer": "Este equipo",
    "createPrimary": "Principal",
    "createRemoveFolder": "Quitar carpeta",
    "createAddFolder": "Añadir carpeta",
    "createAddFolderHint": "Selecciona una o varias",
    "createCancel": "Cancelar",
    "createAction": "Crear proyecto",
    "createSaving": "Creando…",
    "createMemoryHint": "La memoria del proyecto estará disponible en futuros chats.",
