...
sklm: {
    ...
    "remoteHosts": {
      ...
      "sshBody": "PI-Desktop instala pi-host en una máquina a la que ya accede por ssh, verifica la suma de comprobación que publica la versión, lo inicia en bucle de retorno y se empareja con él. Sus propias claves SSH autentican; no se almacena ninguna contraseña.",
      "sshHost": "Host SSH",
