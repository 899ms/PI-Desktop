...
sklm: {
    ...
    modelsSummaryTitle: "Modeller",
    modelsSummaryLoading: "Modeller yükleniyor…",
    modelsSummaryFailed: "Modeller yüklenemedi. Yukarıdaki bağlantıyı kontrol edin veya kimliğiyle bir model ekleyin.",
    manageModels: "Modelleri yönet",
    collapseModels: "Daralt",
    addModelManually: "Elle model ekle",
