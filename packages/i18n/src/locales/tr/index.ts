...
sklm: {
      ...
      sourcesHint:
        "Birden fazla katalog kaynağını aynı anda sorgular. Kaynak, skill marketi şemasına uygun statik bir JSON dosyasıdır — kendi GitHub skill deponuza da işaret edebilir.",
