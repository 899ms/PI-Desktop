...
sklm: {
    ...
    remoteHosts: {
      ...
      sshBody:
        "PI-Desktop, ssh ile zaten erişebildiğiniz bir makineye pi-host kurar, sürümün yayımladığı sağlama toplamını doğrular, geri döngüde başlatır ve onunla eşleşir. Kimlik doğrulamayı kendi SSH anahtarlarınız yapar — hiçbir parola saklanmaz.",
