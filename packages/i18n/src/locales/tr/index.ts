...
export const tr = {
  ...
  project: {
    ...
    createNamePlaceholder: "Proje adı",
    createFoldersLabel: "Klasörler",
    createComputer: "Bu bilgisayar",
    createPrimary: "Birincil",
    createRemoveFolder: "Klasörü kaldır",
    createAddFolder: "Klasör ekle",
    createAddFolderHint: "Bir veya daha fazla seçin",
    createCancel: "İptal",
    createAction: "Proje oluştur",
    createSaving: "Oluşturuluyor…",
    createMemoryHint: "Projenin belleği gelecekteki sohbetlerde kullanılabilir kalır.",
