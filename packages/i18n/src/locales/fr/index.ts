...
sklm: {
    ...
    "remoteHosts": {
      ...
      "sshBody": "PI-Desktop installe pi-host sur une machine à laquelle vous accédez déjà par ssh, vérifie la somme de contrôle publiée par la version, le démarre sur la boucle locale et s'y apparie. Vos propres clés SSH authentifient — aucun mot de passe n'est stocké.",
      "sshHost": "Hôte SSH",
