...
sklm: {
      ...
      sourcesHint:
        "Interroge plusieurs sources à la fois. Une source est un fichier JSON statique au schéma du marché de skills — elle peut pointer vers votre propre dépôt GitHub de skills.",
