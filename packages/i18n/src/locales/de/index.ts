...
export const de = {
  ...
  "search": {
    ...
    messageContext: "Nachrichtenkontext",
    returnToConversation: "Zurück zum Gespräch",
    contextUnavailable: "Nachricht nicht verfügbar. Möglicherweise gelöscht.",
    retry: "Erneut versuchen",
    previousMatch: "Vorheriger Treffer",
    nextMatch: "Nächster Treffer",
    previousMessages: "Vorherige Nachrichten",
    nextMessages: "Nächste Nachrichten",
