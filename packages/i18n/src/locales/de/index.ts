...
sklm: {
    ...
    "remoteHosts": {
      ...
      "sshBody": "PI-Desktop installiert pi-host auf einem Rechner, den Sie bereits per ssh erreichen, prüft die vom Release veröffentlichte Prüfsumme, startet ihn auf Loopback und koppelt sich damit. Ihre eigenen SSH-Schlüssel authentifizieren — es wird kein Passwort gespeichert.",
      "sshHost": "SSH-Host",
