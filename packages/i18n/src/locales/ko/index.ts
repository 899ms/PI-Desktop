...
sklm: {
    ...
    remoteHosts: {
      ...
      transportSsh: "SSH",
      experimentalTitle: "실험적",
      experimentalUnavailable: "아직 사용할 수 없음",
      experimentalLan: "LAN 검색",
      experimentalGateway: "브라우저 접근",
      experimentalMessaging: "메시징",
      experimentalWsl: "WSL",
      experimentalExpose: "이 기기 공유",
    },
